const fn=async()=>{const title=document.createElement('h2')
...
let content=''
switch(event.type){case 'WatchEvent':content=`<a href="https://github.com/${event.repo.name}">
                    <div class="each">
                        <div>
...
break
case 'IssueCommentEvent':content=`<a href="${event.payload.issue.html_url}">
                    <div class="each">
                        <div>
...
break
case 'IssuesEvent':content=`<a href="${event.payload.issue.html_url}">
                    <div class="each">
                        <div>
...
break
case 'PushEvent':content=`<a href="https://github.com/${event.repo.name}">
                    <div class="each">
                        <div>
...
break
case 'PullRequestEvent':case 'PullRequestReviewCommentEvent':content=`<a href="${event.payload.pull_request.html_url}">
                    <div class="each">
                        <div>
