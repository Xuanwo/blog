...
术语：
![函数依赖术语](http://xuanwo.qiniudn.com/learn/func-define.png)
...
### 多值依赖
![多值依赖](http://xuanwo.qiniudn.com/learn/MVD.png)

### 第四范式（4NF）
关系模式R<U,F>符合第一范式，对于R的每一个非平凡多值依赖，X都含有码，则称关系模式R符合第四范式

### 总结
![函数依赖总结](http://xuanwo.qiniudn.com/learn/func-depand-conclusion.png)
...
## 数据库安全性控制
计算机系统的安全模型
![计算机系统的安全模型](http://xuanwo.qiniudn.com/learn/safe-modal.png)
